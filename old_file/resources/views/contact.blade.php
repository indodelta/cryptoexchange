...
<div class="hug-aa-content">
    <div class="hug hug-aa-darkheader hug-contactus-banner">
        <div class="container">
            <div class="row">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                    <center>
                        <span id="hs_cos_wrapper_my_headline" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" data-hs-cos-type="rich_text" data-hs-cos-general-type="widget" style="">
                            <h1>
