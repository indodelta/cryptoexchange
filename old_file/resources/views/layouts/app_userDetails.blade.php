...
.day:hover {
  ...
  @font-face {
    ...
    src: url('fonts/tt0142m_.woff2') format('woff2'),
...
<!-- 		<div class="container">
			<div class="row">
				<div class="col-sm-3 col-md-3">
					<h6>Addresss</h6>
					<p>Perfekt Technologies HK Limited,<br>
					unit 804 8F Boss Commercial Centre<br> Yau Ma Tei Kowloon<br>
					Hong Kong
					</p>
				</div>
				<div class="col-sm-3 col-md-3">
					...
					<h6>Contact</h6>
						...
						<br>
					<a href="" style="text-align:center;margin: :auto;  display: block; color:#003466">support@perfektpay.com</a>
				</div>
				
				<div class="col-sm-3 col-md-3 social social1">
					<h6>Meet us @</h6>
					<ul>
		...
		<div class="copyright">
			<p>© 2017 perfektpay, All Right Reserved.</p>
		</div>
	</footer>
  ...
  <script src="js/bootstrap-datetimepicker.min.js"></script>
    <script type="text/javascript">
           $( document ).ready(function() {
               ...
               /* Auto Suggest phone code*/
				$( "#country" ).change(function() {
					var country = $(this).val();          
					$.ajax({
					        url: 'fetch-country-code',
					        type: 'post',
					        data: {'country':country, '_token': $('input[name=_token]').val()},           
