            ...
            <form style="padding-top:20px;" action="{{route('signuppost')}}" method="post" id="user_register">
              ...
              <div class="form-group">
                <p style="display: inline-block;">
                  ...
                  <label for="test1" style="font-size:16px;font-weight:normal;">I have read and agree to the <a href="" style="color:#6dcff6; text-decoration:none;">Terms of Service</a></label></p>
                </div>
                <br>
                <div class="form-group">
