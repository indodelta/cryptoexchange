...
@section('title', 'Bitcoin sign in | Bitcoin login | Perfekt Capital Limited')
@section('content12')
  <meta name="description" content="Bitcoin is an innovative payment network and a new kind of money. Find all you need to know and get started with Bitcoin login on Perfekt Capital Limited. The Perfekt Capital Limited is a best bitcoin wallet because it can protect by world class security expert, trusted by the millions of user.">
  <meta name=keywords content="Bitcoin sign in, Bitcoin login">
@stop
	<style>
	.sign-back{
...
<form method="post" style="padding-top:20px;" id="login_detail">
  ...
  <div class="form-group">
  <p style="font-size:16px;">Having some trouble? <a href="forgot-password" style="color:#6dcff6; text-decoration:none;">Forgot Password</a></p>
  </div>
