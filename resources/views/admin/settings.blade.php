...
<!--popup model start-->
<div id="trade" class="modal fade" data-backdrop="true">
  <div class="modal-dialog animate" id="animate">
    <div class="modal-content">
      <div class="modal-header">        
        <h4 class="modal-title">Set Trading Price</h4>
      </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="" class="col-form-label">Buy:</label>
                    <div class="field1">
                        <button type="button" id="sub" class="suba">-</button>
                  <input type="text" class="field trading_buy" value="0" id="buy" min="0"  onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="message-text" class="col-form-label">Sell:</label>
                    <div class="field1">
                        <button type="button" id="sub" class="suba">-</button>
                        <input type="text" class="field trading_buy" value="0" id="sell" min="0" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
                        <button type="button" id="add" class="add">+</button>
                    </div>
                </div>
              </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-info"  id="trading_price">Submit</button>
...
<!--########-->
<div id="ticker" class="modal fade" data-backdrop="true">
  <div class="modal-dialog animate" id="animate">
    <div class="modal-content">
      <div class="modal-header">        
        <h4 class="modal-title">Set Ticker Price</h4>
      </div>
      <div class="modal-body">
        <form>
          <div class="offset-sm-2 col-sm-8 ">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="" class="col-form-label">Bid:</label>
                    <div class="field1">
                        <button type="button" id="sub" class="sub">-</button>
                        <input type="text" class="field ticker_paid" value="0" id="bid"  min="-10" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
                        <button type="button" id="add" class="add">+</button>
                    </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="message-text" class="col-form-label">Ask:</label>
                    <div class="field1">
                        <button type="button" id="sub" class="sub">-</button>
                        <input type="text" class="field ticker_paid" value="0" id="ask"  min="-10" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
                        <button type="button" id="add" class="add">+</button>
                    </div>
                </div>
              </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-info" id="ticker_price">Submit</button> 
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
                ...
                <div class="input-group mb-sm">
                  ...
                  <span class="input-group-btn">
                   ...
                   <a href="{{URL('/organize/manageSettingDownload')}}/{{(!empty($_GET['param'])?$_GET['param']:'null')}}/{{(!empty($_GET['column'])?$_GET['column']:'null')}}">
                    ...
                    <button class="btn btn dropdown-toggle indigo" type="button" data-toggle="dropdown">Setting
                    <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                      <li style="color:black" class="nav-active-theme"><a data-toggle="modal" data-target="#trade">Trading</a></li>
                      <li style="color:black" class="nav-active-theme"><a data-toggle="modal" data-target="#ticker">Ticker Price</a></li>
                    </ul>
         ...
         @foreach($userList as $key=>$val)                               
          <tr>
            ...
            <td class="text-center">
              <div class="field1">
                  <button type="button" id="sub" class="suba">-</button>
                  <input type="text" class="field trading_buy" value="{{$val->trading_buy}}" id="{{$key}}tb" min="0" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
                  <button type="button" id="add" class="add">+</button>
              </div>
            </td>
            ...
            <td class="text-center">
              <div class="field1">
                  <button type="button" id="sub" class="suba">-</button>
                  <input type="text" class="field trading_sell" value="{{$val->trading_sell}}" id="{{$key}}ts" min="0" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
                  <button type="button" id="add" class="add">+</button>
              </div></td>
            <td class="text-center">
              <div class="field1">
