        ...
        <tbody>  
         @foreach($userList as $key=>$val)                               
          <tr>
            ...
            <td style="text-align:left;"><i class="fa fa-user"></i><a href="admin-edit-user/{{Crypt::encrypt($val->user_id)}}" style="text-decoration: underline;color:#007bff;">@if($val->first_name)&nbsp;{{$val->first_name}}@endif
            ...
            <td class="text-center">
                <button class="btn success btn-xs update-value" value="{{Crypt::encrypt($val->id)}}" data-action="1" data-mode="{{Crypt::encrypt($val->modetype)}}">Approve</button>&nbsp;
                <button class="btn danger btn-xs update-value" value="{{Crypt::encrypt($val->id)}}" data-action="2" data-mode="{{Crypt::encrypt($val->modetype)}}">Cancel</button>
            </td>
          </tr> 
        @endforeach       
      </tbody>
