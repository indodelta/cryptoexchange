...
<br><br>        
We have recevied a request to withdrawal <strong>{{sprintf("%.2f", $data->amount)}} {{$currency}}</strong> from your perfektpay account to 
<br><br>
Account Number &nbsp;:&nbsp;<strong>{{$data->beneficiary_account_no}}</strong>
<br>
Bank Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<strong>{{$data->bank_name}}</strong>
<br>
Beneficiary Name:&nbsp;<strong>{{$data->beneficiary_name}}</strong>
<br>
<br>
