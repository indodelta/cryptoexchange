      ...
      <table class="table table-bordered b-t">
        ...
        @foreach($userList as $key=>$val) 
          <tr>
           ...
           <span class="badge info pos-rlt mr-2" style="font-size: 85%;padding: 0.30em .7em;"><b class="top b-success pull-in" ></b>Credited</span>
            @elseif($val->type == 1)
              
              <span class="badge orange pos-rlt mr-2" style="font-size: 85%;padding: 0.30em .7em;"><b class="top b-success pull-in" ></b>Debited</span>
            @endif
          </td>
        </tr>
        @endforeach
