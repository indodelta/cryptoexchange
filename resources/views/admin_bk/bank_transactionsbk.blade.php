                      ...
                      <div class="col-sm-2"> 
                             <div class="form-group">
                               ...
                               <div class="input-group mb-sm">
                                 <input class="form-control" type="text" placeholder="Enter Amount" name="param" value="">
                               </div>
                             </div>
                           </div>
                           <div class="col-sm-3"> 
                             <div class="form-group">
                               <label>Remarks</label>
                               <div class="input-group mb-sm">
                                 <input class="form-control" type="text" placeholder="Remarks" name="param" value="">
                               </div>
                             </div>
                           </div>
                           <div class="col-sm-3">       
